 ...
 * @param {string} argument.slug
 * @param {object} argument.comment
 * @param {string} argument.comment.body
 */
export const createComment = createAsyncThunk(
  'comments/createComment',
  async ({ slug, comment: newComment }, thunkApi) => {
    // try {
      const { comment } = await agent.Comments.create(slug, newComment);
 ...
 * @param {object} argument
 * @param {string} argument.slug
 * @param {string} argument.commentId
 */
